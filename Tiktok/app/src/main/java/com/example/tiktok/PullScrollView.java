...
//        init(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 300, getResources().getDisplayMetrics());
        mHeaderVisibleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100, getResources().getDisplayMetrics());
    }
    ...
    private void doActionMove(MotionEvent event) {
        ...
        if (isMoving) {
            ...
            mCurrentBottom = (int) (mInitBottom + contentMoveHeight);
            ...
            // 移动header view
            mHeader.layout(mHeader.getLeft(), mInitTop, mHeader.getRight(), mCurrentBottom);
        }
    }

    private void rollBackAnimation() {
        TranslateAnimation tranAnim = new TranslateAnimation(0, 0,
                Math.abs(mInitBottom - mCurrentBottom), 0);
